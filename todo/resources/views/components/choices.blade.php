...
<div>
    <div wire:ignore class="input-group mb-3">
        ...
        <input type="text" {{ $attributes->merge(['class' => 'js-choice form-control']) }} >
    </div>
    ...
    <script>
        ...
        const choices = new Choices(el, {
            ...
            addItemText: (value) => {
                return `Нажмите Enter, чтобы добавить тег "${value}"`;
            },
            maxItemText: (maxItemCount) => {
                return `Можно добавть не более ${maxItemCount} тегов`;
            },
         });
        ...
        window.addEventListener('editTask', (e) => {
            const values = e.detail.tags;
            choices.setValue(values);
            // @this.set('{{ $attributes['wire:model'] }}', values)
        });

        document.addEventListener('clearStore', () => {
           choices.clearStore();
        });
    });
    </script>
